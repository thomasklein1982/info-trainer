...
export const data={
  id: "array-ausgabe-liste",
  title: "Array-Ausgabe-Liste",
  check: {
    init: async ()=>{
      $Exercise.deleteMain();
    ...
    testcases: [
        {
          ...
          info: "Die Elemente werden in richtiger Reihenfolge durchnummeriert (1. , 2. , 3. , ...) ausgegeben.",
          count: 10
        },
      ]
  },
