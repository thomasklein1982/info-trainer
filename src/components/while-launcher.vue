<template>
  ...
  <Button @click="openDialog" label="WHILE-Simulator öffnen"/>
  <Dialog ref="dialog" :header="exerciseData? exerciseData.title:'WHILE-Programm'" v-model:visible="show" :closable="true" maximizable :close-on-escape="false">
...
export default{
  components: {
    ProgressBar,ExerciseProgress,WhileSimulator
  },
  emits: [
    "show-feedback"
  ],
