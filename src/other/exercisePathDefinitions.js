  ...
  paths: [
    {
      ...
      exercises: ["db-select-all","db-select-avg", "db-select-gehalt", "db-select-frieda", "db-select-fachbereiche", "db-select-alter", "db-select-klassenliste", "db-select-beste","db-select-berufe"]
    }
  ]
}
